function [NewTessFile, iSurface] = tess_create_multilayer(TessFiles, NewComment, fileType, Labels, isKeepLabels)
...
% Adapted to be used for multilayer surfaces by Jan Schalla 2025
...
NewTessFile = file_fullpath(NewTessFile);
